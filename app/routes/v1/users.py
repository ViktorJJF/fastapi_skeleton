...
from app.schemas.core.responses import (
    SingleItemResponse, PaginatedApiResponse, 
    DeleteResponse, DeleteManyResponse, ListResponse
)
...
async def update_user(
    ...
    return await user_controller.update(id=user_id, item=user_in, request=request, db=db)
...
async def read_users_paginated(
    ...
    return await user_controller.list_paginated(request=request, pagination=pagination, db=db)
...
async def read_user_me(
    ...
    return await user_controller.get_one(id=str(current_user.id), request=request, db=db) 