...
async def test_get_cities():
    ...
    """
    async with AsyncClient(app=app, base_url="http://test") as client:
        response = await client.get(f"{settings.API_V1_STR}/cities/")
...
async def test_get_city():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        # Now get the city
        get_response = await client.get(f"{settings.API_V1_STR}/cities/{city_id}")
...
async def test_update_city():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        update_response = await client.put(
            f"{settings.API_V1_STR}/cities/{city_id}",
            json={
...
async def test_delete_city():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        # Now delete the city
        delete_response = await client.delete(f"{settings.API_V1_STR}/cities/{city_id}")
