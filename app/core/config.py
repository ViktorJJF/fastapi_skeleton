...
class Config(BaseSettings):
    ...
    GOOGLE_CLOUD_LOGGING_ENABLED: bool = (
        os.getenv("GOOGLE_CLOUD_LOGGING_ENABLED", "false").lower() == "true"
    )
    ...
    AZURE_MONITOR_ENABLED: bool = (
        os.getenv("AZURE_MONITOR_ENABLED", "false").lower() == "true"
    )
    AZURE_APPINSIGHTS_CONNECTION_STRING: Optional[str] = os.getenv(
