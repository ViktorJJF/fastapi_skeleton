...
class TelegramNotifier:
    ...
    def _format_error_message(
        self, error: Any, traceback_info: Optional[str] = None
    ) -> str:
        """
        ...
        with logger.contextualize(error_type=type(error).__name__):
            ...
            if traceback_info:
                ...
                if original_length > 3000:
                    ...
                    logger.debug(
                        f"Traceback truncated from {original_length} to 3000 chars"
                    )
    ...
    def send_notification(self, message: str) -> None:
        ...
        with logger.contextualize(
            notification_type="general", message_length=len(message)
        ):
